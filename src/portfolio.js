  ...
  data: [
    {
      ...
      skills: [
        "⚡ Building scalable backend services and enterprise applications with .NET Core",
        "⚡ Designing clean, maintainable APIs and application architecture",
        "⚡ Working with C#, ASP.NET Core, Entity Framework, and SQL Server",
        "⚡ Delivering production-ready solutions with strong performance and reliability",
      ],
      softwareSkills: [
        {
          skillName: ".NET",
    ...
    },
    {
      ...
      skills: [
        "⚡ Building Android applications with Kotlin for responsive mobile experiences",
        "⚡ Developing clean app architecture and UI flows using Android Studio",
        "⚡ Working with version control and collaboration using Git and GitHub",
      ],
      softwareSkills: [
        {
          skillName: "Kotlin",
